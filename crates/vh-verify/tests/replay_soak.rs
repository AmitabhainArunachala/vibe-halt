...
#[test]
fn fixed_reference_replays_to_one_tier_1_hash() {
    ...
    assert_eq!(
        ...
        "soak: receipt-schema=vh-verify-soak-v1 verdict=PASS determinism-tier=Tier-1 evidence-grade=D0 root-seed=0x000000000000d1ce universe=0 workload=vh-verify-reference trace-format=v0 runs=64 hash=eafa30e8a7a6c82939ea3f755bc866ab events=33 observable-schema=vh-verify-observable-v2 observable-fingerprint=39f727ed5d8a949c1f5a1243bd6d1d10 upH=123 upH-scope=boundary-telemetry"
    );
}
...
fn zero_run_soak_is_rejected() {
    ...
    assert_eq!(
        ...
        "soak: receipt-schema=vh-verify-soak-v1 verdict=ERROR determinism-tier=Tier-1 evidence-grade=D0 root-seed=0x000000000000d1ce universe=0 workload=vh-verify-reference trace-format=v0 observable-schema=vh-verify-observable-v2 requested-runs=0 error-code=zero-runs"
    );
}
